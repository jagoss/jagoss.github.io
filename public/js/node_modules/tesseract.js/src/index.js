const adapter = require('tesseract.js/src/node')
const circularize = require('tesseract.js/src/common/circularize.js')
const TesseractJob = require('tesseract.js/src/common/job');
